 ...
 */
var getDateAgo = function(d, days) {
  const date = new Date (d);
 ...
 */
var testPerformance = function(interations, func) {
  var time = Date.now();
  if (typeof func === 'function') for (var i = interations; i--;) func();
